...
<div class="form-group">
    ...
    <input type="text" name="data" placeholder="Data de Nascimento" class="form-control" id="date" value="{{isset($registro->data) ? $registro->data : ''}}">
</div>
...
<div class="form-group">
    ...
    <input type="email" name="email" class="form-control" placeholder="Email" id="inputEmail" value="{{ isset($registro->email) ? $registro->email : '' }}">
</div>
