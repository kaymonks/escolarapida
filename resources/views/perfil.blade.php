                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <a href="{{ route($perfil.'.editar', ['id'=>$id]) }}" class="btn btn-sm btn-primary pull-right"><i class="fa fa-edit"></i> Editar</a>
                        </div>
                            ...
                            <div id="accordion" class="box-group">
                                <div class="panel box box-primary">
                                    ...
                                    <div id="collapseOne" class="panel panel-collapse collapse">
                                        <div class="box-body">
                                            <table class="table">
                                                <tr><td width="200px">Nome</td><td>{{ $registro->nome }}</td></tr>
                                                <tr><td width="200px">Data de Nascimento</td><td>{{ $registro->data_nascimento }}</td></tr>
