...
-- Copiando dados para a tabela escola_rapida_2.alunos: ~2 rows (aproximadamente)
DELETE FROM `alunos`;
...
-- Copiando dados para a tabela escola_rapida_2.aluno_responsavel: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela escola_rapida_2.escolas: ~3 rows (aproximadamente)
DELETE FROM `escolas`;
...
INSERT INTO `eventos` (`id`, `titulo`, `descricao`, `date`, `time`, `created_at`, `updated_at`) VALUES
	...
	(20, 'ttse', 'teste', '2017-11-01', '20:08:00', '2017-11-07 22:08:21', '2017-11-07 22:08:21');
...
CREATE TABLE IF NOT EXISTS `mensagem_destinatario` (
  ...
  `tipo_destinatario` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Copiando dados para a tabela escola_rapida_2.mensagem_destinatario: ~15 rows (aproximadamente)
DELETE FROM `mensagem_destinatario`;
/*!40000 ALTER TABLE `mensagem_destinatario` DISABLE KEYS */;
INSERT INTO `mensagem_destinatario` (`id`, `mensagem_id`, `destinatario_id`, `destinatario_escola_id`, `destinatario_professor_id`, `tipo_destinatario`, `created_at`, `updated_at`) VALUES
	(2, 12, 16, NULL, NULL, 4, '2017-12-05 20:23:56', '2017-12-05 20:23:56'),
	(5, 14, 16, NULL, NULL, 4, '2017-12-05 20:27:31', '2017-12-05 20:27:31'),
	(12, 21, 19, NULL, NULL, 4, '2017-12-06 16:00:12', '2017-12-06 16:00:12'),
	(13, 22, 20, NULL, NULL, 4, '2017-12-06 18:01:48', '2017-12-06 18:01:48'),
	(16, 41, NULL, 6, NULL, 4, '2017-12-06 19:11:25', '2017-12-06 19:11:25'),
	(17, 42, NULL, 6, NULL, 4, '2017-12-06 19:52:13', '2017-12-06 19:52:13'),
	(18, 43, NULL, 6, NULL, 4, '2017-12-06 19:57:26', '2017-12-06 19:57:26'),
	(19, 44, NULL, 6, NULL, 4, '2017-12-07 18:38:47', '2017-12-07 18:38:47');
...
-- Copiando dados para a tabela escola_rapida_2.mensagens: ~27 rows (aproximadamente)
...
-- Copiando dados para a tabela escola_rapida_2.professores: ~1 rows (aproximadamente)
...
INSERT INTO `responsaveis` (`id`, `nome`, `sexo`, `data_nascimento`, `telefone_id`, `escola_id`, `email`, `endereco`, `cep`, `numero`, `bairro`, `estado`, `cidade`, `user_id`, `created_at`, `updated_at`) VALUES
	(16, 'teste', 'm', '2017-12-05', 115, 6, ' resp2@escola.com', 'fsd', '325', 323, 'gdg', 'gdgs', 'dfgdf', 18, '2017-12-05 18:30:47', '2017-12-05 18:30:47'),
...
-- Copiando dados para a tabela escola_rapida_2.telefones: ~128 rows (aproximadamente)
...
-- Copiando dados para a tabela escola_rapida_2.turmas: ~3 rows (aproximadamente)
DELETE FROM `turmas`;
...
-- Copiando dados para a tabela escola_rapida_2.turma_professores: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela escola_rapida_2.users: ~6 rows (aproximadamente)
DELETE FROM `users`;
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `permission_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(2, 'escola', 'escola1@escola1.com', '$2y$10$KU2CXv0wr0VqYMlvni4s0eBGNI89uR1czHdLjr8hjxNMjJFK/EOF.', 2, 'uDB7eD0iDgi515Rdj95yPLNrbAlB8OJnWImf1SjlBybbghQr6IsVfAXuE1IB', '2017-11-08 19:10:49', '2017-12-07 23:17:43'),
	(10, 'professor', 'professor2@escola.com ', '$2y$10$P4U/4gE4y63QE6FISBjoZeu0VQwgbmCpBCp0KYmkU149P2JEAH.aK', 3, 'FMxdGJADOoiuRWZ6UzQnK9hfgsxf3Fl7HJZibt7sPwv5eBK9HWpEgjLhF5Aj', '2017-11-12 00:42:35', '2017-12-07 22:24:54'),
	...
	(90, 'responsavel', 'pai1@pai.com', '$2y$10$3nc5SxwYsKrZbw7JRI.3lOzXbbBn8bjBER1tc3vFtP31h/EfhXgca', 4, 'EeZM98v8lZvjPt9ID3OSX1chj5dMbsjQCxU7yIAoUZ6RKZUx0OdpZU8UovKw', '2017-12-05 23:29:16', '2017-12-07 20:43:25'),
